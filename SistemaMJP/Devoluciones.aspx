<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Devoluciones.aspx.cs" Inherits="SistemaMJP.Devoluciones" %>
    ...
    margin-left: 2%;"></i></asp:LinkButton> 
                ...
                <div class="form-group" id="listBodega" runat="server">
                    ...
                    <div style="display: none;" id="MsjErrorlistBodega" class="col-md-offset-2" runat="server">
                        <label class="mensajeError">Debe seleccionar una bodega para realizar la devolucion</label>
                        <br/> 
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="RealizarBaja">
                        <asp:Button ID="btnBajar" class="btn btn-default" runat="server" Text="Aceptar" OnClick="devolver" />
                    </div>
                </div>
